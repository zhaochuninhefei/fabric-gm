...
import (
	...
	pm "gitee.com/zhaochuninhefei/fabric-protos-go-gm/msp"
...
var _ = Describe("DiscoveryService", func() {
	...
	It("discovers network configuration, endorsers, and peer membership", func() {
		...
		chaincodePath := components.Build("gitee.com/zhaochuninhefei/fabric-gm/integration/chaincode/simple/cmd")
		chaincode = nwo.Chaincode{
			Name:                "mycc-lifecycle",
			Version:             "1.0",
			Lang:                "binary",
