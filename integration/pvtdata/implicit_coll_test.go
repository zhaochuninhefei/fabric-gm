...
import (
	...
	"gitee.com/zhaochuninhefei/fabric-gm/integration/chaincode/kvexecutor"
	...
	BeforeEach(func() {
		...
		testChaincode = chaincode{
			Chaincode: nwo.Chaincode{
				Name:        "kvexecutor",
				Version:     "1.0",
				Path:        components.Build("gitee.com/zhaochuninhefei/fabric-gm/integration/chaincode/kvexecutor/cmd"),
				Lang:        "binary",
