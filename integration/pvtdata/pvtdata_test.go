...
import (
	...
	mspp "gitee.com/zhaochuninhefei/fabric-protos-go-gm/msp"
		...
		It("disseminates private data per collections_config1 (positive test) and collections_config8 (negative test)", func() {
			...
			testChaincode := chaincode{
				Chaincode: nwo.Chaincode{
					Name:    "marblesp",
					Version: "1.0",
					Path:    "gitee.com/zhaochuninhefei/fabric-gm/integration/chaincode/marbles_private/cmd",
					Ctor:    `{"Args":["init"]}`,
	...
	Describe("Pvtdata behavior with untouched peer configs", func() {
		...
		BeforeEach(func() {
			...
			newLifecycleChaincode = nwo.Chaincode{
				Name:              "marblesp",
				Version:           "1.0",
				Path:              components.Build("gitee.com/zhaochuninhefei/fabric-gm/integration/chaincode/marbles_private/cmd"),
				Lang:              "binary",
