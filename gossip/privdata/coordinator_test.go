...
import (
	...
	gmetricsmocks "gitee.com/zhaochuninhefei/fabric-gm/gossip/metrics/mocks"
	privdatacommon "gitee.com/zhaochuninhefei/fabric-gm/gossip/privdata/common"
	"gitee.com/zhaochuninhefei/fabric-gm/gossip/privdata/mocks"
...
func TestCoordinatorToFilterOutPvtRWSetsWithWrongHash(t *testing.T) {
	...
	*/
	...
	hash := util2.ComputeSHA256ButSm3([]byte("rws-original"))
	bf := &blockFactory{
		channelID: "testchannelid",
	}
